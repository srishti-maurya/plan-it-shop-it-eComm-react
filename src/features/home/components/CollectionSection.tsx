...
function Category({
  ...
  return (
    ...
    >
      ...
      />
      <h3 className="text-center text-lg font-semibold dark:text-slate-100">{title}</h3>
    </button>
  );
}
...
export function CollectionSection() {
  return (
    <>
      <h2 className="mt-8 text-center text-2xl font-bold text-primary dark:text-primary-300 md:text-3xl">
